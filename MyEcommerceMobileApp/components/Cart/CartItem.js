                ...
                style={{ width: '100%', height: 100, marginVertical: 6, flexDirection: 'row', alignItems: 'center', }}>
                    ...
                    <View style={{}}>
                        ...
                        <View style={{ marginTop: 4, flexDirection: 'row', alignItems: 'center', opacity: 0.6, }}>
                            <Text style={{ fontSize: 14, fontWeight: '400', maxWidth: '85%', marginRight: 4, }}> {product.unitPrice} </Text>
                        </View>
                    </View>
                    <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', }}>
                        <View style={{ flexDirection: 'row', alignItems: 'center', }}>
                            <View style={{ borderRadius: 100, marginRight: 20, padding: 4, borderWidth: 1, opacity: 0.5, }}>
                                <TouchableOpacity onPress={() => {decre(product.product)}}>
                                    <MaterialCommunityIcons name="minus" style={{ fontSize: 16, }} />
                                </TouchableOpacity>
                            </View>
                            <Text>{product.quantity}</Text>
                            <View style={{ borderRadius: 100, marginLeft: 20, padding: 4, borderWidth: 1, opacity: 0.5, }}>
